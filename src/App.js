  ...
  return (
    <div className="header">
      ...
      <div className="about-me">
        ...
        <p className="profile-detail">Hello, I'm John Carlo Dizon Software Engineer and and Video Editor, currently looking for Connections in Software Engineering Industry to make more knowledge and Experience. Offering my services in Web Designing and Video Editing, to help your business improve your websites and videos. </p>
      </div>     
    </div>
  )
}
